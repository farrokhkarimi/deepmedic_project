...
### this is a runner script for deepmedic source that copied and modified from deepMedicRun script in the source code directory
...
#                        MAIN                   #
#################################################
def deepmedic_runner(device_name, model_cfg_file_path, test_cfg_file_path, train_cfg_file_path, saved_model_path, reset_trainer):
